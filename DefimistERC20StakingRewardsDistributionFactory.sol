...
contract DefimistERC20StakingRewardsDistributionFactory is
    ERC20StakingRewardsDistributionFactory
{
    ...
    function initialize(
        ...
        require(
            ...
            "DefimistERC20StakingRewardsDistributionFactory: 0-address reward tokens validator"
        );
        require(
            _stakableTokenValidatorAddress != address(0),
            "DefimistERC20StakingRewardsDistributionFactory: 0-address stakable token validator"
        );
    ...
    modifier onlyUninitialized() {
        require(
            !initialized,
            "DefimistERC20StakingRewardsDistributionFactory: already initialized"
        );
        _;
    }
    ...
    modifier onlyInitialized() {
        require(
            initialized,
            "DefimistERC20StakingRewardsDistributionFactory: not initialized"
        );
        _;
    }
}
